...
public class ExchangeApplication {
    ...
    CommandLineRunner lookup(SmsClient smsClient, YaghutClient yaghutClient) {
        return args -> {
            ...
            NormalTransferResponse transferResponse = yaghutClient.normalTransfer(yaghliUsername, yaghliPassword, yaghliDepositNo, mojahedDepositNo, amount, destinationComment, sourceComment);
