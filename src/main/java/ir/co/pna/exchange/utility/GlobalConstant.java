...
public class GlobalConstant {
    ...
    public static final String OPERATIONAL_EXCHANGER_OWNER_BANK_ACCOUNT_ID = "151-701-6113835-1"; // tavalaeeDepositNo
    ...
    private static String shahsavaniMobileNumber = "09059242876";

    public static final String OPERATIONAL_RETURN_OWNER_BANK_ACCOUNT_ID = "159-701-6471174-1"; // mojahed
